 ...
 const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
  ...
  try {
   ...
   const formDataToSend = {
    ...
    runtime: formData.runtime ? parseInt(formData.runtime.toString(), 10) : undefined,
     ...
     <form onSubmit={handleSubmit} className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
       ...
       <div className="space-y-6">
        ...
        {/* Overview */}
        <div>
         <label htmlFor="overview" className="block text-sm font-semibold text-gray-900 mb-2">
       ...
       <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
         <div>
          <label htmlFor="popularity" className="block text-sm font-semibold text-gray-900 mb-2">
           Popularity <span className="text-red-500">*</span>
          </label>
          <input
           id="popularity"
           type="number"
         ...
         <div>
          <label htmlFor="vote_average" className="block text-sm font-semibold text-gray-900 mb-2">
        ...
        <div className="grid grid-cols-2 gap-4">
         <div>
          <label htmlFor="vote_count" className="block text-sm font-semibold text-gray-900 mb-2">
           Votes <span className="text-red-500">*</span>
          </label>
          <input
           id="vote_count"
           type="number"
         ...
         <div>
          <label htmlFor="runtime" className="block text-sm font-semibold text-gray-900 mb-2">
           Runtime (min)
          </label>
          <input
           id="runtime"
        ...
        <div>
         <label htmlFor="link" className="block text-sm font-semibold text-gray-900 mb-2">
          External Link <span className="text-gray-500 text-xs">(optional)</span>
         </label>
         <input
          id="link"
          type="url"
